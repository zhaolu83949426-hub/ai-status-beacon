...
- 単灯モードでは 1 回に 1 色だけを表示し、3 灯モードでは赤・黄・緑のランプをそれぞれ使います
- 緑は、いま落ち着いた状態であること、または作業が終わったことを表します
- 作業が終わった直後は、完了に気づきやすいように緑ランプが数回点滅します
- 黄は、エージェントが作業中であること、考え中であること、またはあなたの確認や注意が必要なことを表します
- 黄が点滅し続けるときは、権限確認のように今すぐ見たほうがよい通知があることを意味します
- 赤はエラーや異常を表します
- 複数のエージェントが同時に動いているときは、その中でいちばん先に見るべきサインを優先して表示します
